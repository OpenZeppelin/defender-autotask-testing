...
// tests
xdescribe('monitor compound for distribution bugs', () => {
  describe('handleTransaction', () => {
    ...
    xit('returns findings if contract address matches and monitored event was emitted', async () => {
      mockTxEvent.transaction.to = validComptrollerAddress;
      ...
      console.log("expected finding here", expectedFinding)
...
xit ('get forta alerts', async() => {
  let alerts = await getFortaAlerts('0xfca83adc900f88f22dafcd91117d0929343cba3f18e4607bcd861ff0bcd706fa', 14517164, 14569190)
...
it('Runs autotask against blocks in configuration file', async () => {
  ...
  console.log("autotask event right here", autotaskEvents)
